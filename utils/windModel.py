...
class Wind:
    ...
    def __init__(self, *args):
        ...
        if (self.windType == 'SINE') or (self.windType == 'RANDOMSINE'):
            ...
            self.w6 = 0.02 #reference height wind speed
            self.z0 = 0.6  #0.045 if cat=="C" else 0.6
    ...
    def wind_shear(states,wind_direct):
        z = states[2]
        r = states[3]
        p = states[4]
        y = states[5]
        ...
        b = np.log(abs(z)/self.z0)/np.log(20/self.z0) #reference height/z0???
        u = b*(np.dot(-self.w6,W))
